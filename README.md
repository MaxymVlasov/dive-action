...
jobs:
  dive:
    ...
    steps:
      ...
      - name: Dive
        uses: MaxymVlasov/dive-action@v1.5.1
        with:
          image: sample:latest
...
| collapse-inefficient-files-details | Boolean | false | `false`                                                                     | Collapse the inefficient files table in PR comments using details/summary tags                                                                                                                                                                                             |
